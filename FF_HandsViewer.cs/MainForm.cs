...
namespace hands_viewer.cs
{
    ...
    public partial class MainForm : Form
    {
        ...
        private delegate void UpdateKaraokeDelegate(string letter);
        public void UpdateKaraoke(string letter)
        {
            this.Invoke(new UpdateKaraokeDelegate(delegate(string l)
            {
                ...
                int solved = labelSolved.Text.Length;
                string next = labelFull.Text.Substring(solved, 1);
                if (next == l)
                {
                    ready = false;
        ...
        {
            string[] words = {"BOND", "MAN", "BECON", "FOBIA", "CIAN", "DUMB", "CODE" };
            Bitmap[] images = {
        ...
        private void gestureInfo_TextChanged(object sender, EventArgs e)
        {
